...
export function loadJettonMaster$Data(slice: Slice) {
    ...
    return { $$type: 'JettonMaster$Data' as const, owner: _owner, jetton_content: _jetton_content, total_supply: _total_supply, total_staked: _total_staked, reserve_fund: _reserve_fund, defi: _defi, market_entropy: _market_entropy, ai_bias: _ai_bias, neural: _neural, is_frozen: _is_frozen };
}
...
export function storeJettonWallet$Data(src: JettonWallet$Data) {
    return (builder: Builder) => {
        ...
        b_0.storeAddress(src.owner);
        b_0.storeAddress(src.master);
        b_0.storeInt(src.last_interaction, 257);
    };
}
...
export function loadJettonWallet$Data(slice: Slice) {
    ...
    const _owner = sc_0.loadAddress();
    const _master = sc_0.loadAddress();
    const _last_interaction = sc_0.loadIntBig(257);
    return { $$type: 'JettonWallet$Data' as const, balance: _balance, owner: _owner, master: _master, last_interaction: _last_interaction };
}
...
export function loadTupleJettonWallet$Data(source: TupleReader) {
    ...
    const _owner = source.readAddress();
    const _master = source.readAddress();
    const _last_interaction = source.readBigNumber();
    return { $$type: 'JettonWallet$Data' as const, balance: _balance, owner: _owner, master: _master, last_interaction: _last_interaction };
}
...
export function storeTupleJettonWallet$Data(source: JettonWallet$Data) {
    ...
    builder.writeAddress(source.owner);
    builder.writeAddress(source.master);
    builder.writeNumber(source.last_interaction);
    return builder.build();
}
...
async function JettonMaster_init(owner: Address, content_url: string) {
    const __code = Cell.fromHex('');
...
const JettonMaster_types: ABIType[] = [
    ...
    {"name":"JettonMaster$Data","header":null,"fields":[{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"jetton_content","type":{"kind":"simple","type":"cell","optional":false}},{"name":"total_supply","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"total_staked","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"reserve_fund","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"defi","type":{"kind":"simple","type":"DeFiParams","optional":false}},{"name":"market_entropy","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"ai_bias","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"neural","type":{"kind":"simple","type":"NeuralState","optional":false}},{"name":"is_frozen","type":{"kind":"simple","type":"bool","optional":false}}]},
    {"name":"JettonWallet$Data","header":null,"fields":[{"name":"balance","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"master","type":{"kind":"simple","type":"address","optional":false}},{"name":"last_interaction","type":{"kind":"simple","type":"int","optional":false,"format":257}}]},
]
...
export const GAS_CONSUMPTION = 100000000n;
...
export class JettonMaster implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: CognitiveFeedback | NeuralCommand | Stake | Unstake | Deploy) {
