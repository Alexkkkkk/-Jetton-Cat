...
### Mint
TL-B: `mint#074b3fde amount:coins recipient:address = Mint`
Signature: `Mint{amount:coins,recipient:address}`

### PeerKnowledgeExchange
TL-B: `peer_knowledge_exchange#499c7c16 sender_master:address apr_data:int257 ai_risk_score:int257 policy_weight:int257 = PeerKnowledgeExchange`
Signature: `PeerKnowledgeExchange{sender_master:address,apr_data:int257,ai_risk_score:int257,policy_weight:int257}`

### AddPeer
TL-B: `add_peer#029c2db3 peer_address:address = AddPeer`
Signature: `AddPeer{peer_address:address}`
